public class PruebaReferencia2 {
  public static void main(String[] args) {
    ...
    System.out.println(cuentaJefer.titular.nombre); // En este caso daria null porque si estamos haciendo la referencia, pero no hemos asignado ningun valor a nombre de la clase cliente. Ademas en la linea 8 si hestamos llamando correctamente. 
